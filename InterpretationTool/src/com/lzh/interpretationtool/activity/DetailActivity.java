...
import com.lzh.interpretationtool.tool.CustomAudioIcon;
...
public class DetailActivity extends Activity implements OnClickListener,OnKeyListener{
	
	private static final String TAG = "com.example.natrue.DetailActivity";
	
	public static final String MUSIC_LENGTH = "com.lzh.interpretationtool.activity.DetailActivity.MUSIC_LENGTH";
	public static final String CURRENT_POSITION = "com.lzh.interpretationtool.activity.DetailActivity.CURRENT_POSITION";
	public static final String CURRENT_MUSIC = "com.lzh.interpretationtool.activity.DetailActivity.CURRENT_MUSIC";
	...
	public boolean onKeyDown(int keyCode, KeyEvent event) {
		...
		if (event.getKeyCode()==KeyEvent.KEYCODE_BACK) {
			Intent intent=new Intent(DetailActivity.this,Consecutive.class);
